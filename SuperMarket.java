class SuperMarket{
	   ...
	   static String[] hairProducts = {"Pantene", "Clinic Plus", "Dove", "Head & Shoulders", "Herbal Essences", "L'Oreal", "Garnier", "Tresemme", "Sunsilk", "Matrix", "Aveda", "Redken", "Biolage", "Nioxin", "Paul Mitchell"};
       ...
       static String[] cafes = {"Starbucks", "Dunkin'", "Tim Hortons", "Costa Coffee", "Peet's Coffee", "Café Nero", "Blue Bottle Coffee", "The Coffee Bean", "Caribou Coffee", "Caffè Bene", "Panera Bread", "Gregorys Coffee", "Stumptown Coffee", "La Colombe Coffee", "Intelligentsia Coffee"};
